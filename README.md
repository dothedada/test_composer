...
2. [Conceptos](./docs/conceptos.md)
    ...
    * [Intro: Máquinas, VM y Contenedores](./docs/conceptos.md#intro-máquinas-vm-y-contenedores)
    * [¿Cómo funciona esto?](./docs/conceptos.md#cómo-funciona-esto)
        * [AIUUURAAA (_--help_)](./docs/conceptos.md#aiuuuraaa---help)
        * [Los planos (imágenes o _images_)](./docs/conceptos.md#los-planos-imágenes-o-images)
        * [Cosas que no queremos contenedorizar (_dockerignore_)](./docs/conceptos.md#cosas-que-no-queremos-contenedorizar-dockerignore)
        * [La ejecución (los contenedores)](./docs/conceptos.md#la-ejecución-los-contenedores)
        * [La memoria (los volúmenes o _volumes_)](./docs/conceptos.md#la-memoria-los-volúmenes-o-volumes)
        * [Rendimiento y publicación](./docs/conceptos.md#rendimiento-y-publicación)
    * [Dentro del Contenedor (_exec_)](./docs/conceptos.md#dentro-del-contenedor-terminalception-o-exec)
    * [Por fuera del contenedor (Red o _network_)](./docs/conceptos.md#por-fuera-del-contenedor-redes-o-networks)
